      ...
      <svg viewBox="0 0 60 40">
        <g>
          ...
          <g>
            <path
              fill="#EA574C"
              d="M30,13.4c-1.833-2.08-4.51-3.4-7.5-3.4c-5.522,0-10,4.477-10,10c0,5.521,4.478,10,10,10
						c2.99,0,5.667-1.32,7.5-3.4c-1.552-1.763-2.5-4.065-2.5-6.6S28.448,15.162,30,13.4z"
            />
            <path
              fill="#EA574C"
              d="M30,13.4c-1.552,1.762-2.5,4.067-2.5,6.6s0.948,4.837,2.5,6.6c1.552-1.763,2.5-4.065,2.5-6.6
						S31.552,15.162,30,13.4z"
            />
          </g>
          <path
            fill="#E9D41E"
            d="M37.5,10c-2.99,0-5.667,1.32-7.5,3.4c-0.433,0.492-0.812,1.03-1.144,1.6h2.288
